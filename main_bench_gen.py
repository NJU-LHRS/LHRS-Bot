...
def main(config: ml_collections.ConfigDict):
    ...
    with torch.no_grad():
        for data_dict in tqdm(question_answer, desc="Evaluating"):
            ...
            answer_dict["qa_pred"] = defaultdict(list)
            ...
            for qa_pair in qa_pairs:
                ...
                answer_dict["qa_pred"]["question"].append(question)
                answer_dict["qa_pred"]["choices"].append(choices)
                answer_dict["qa_pred"]["answer"].append(answer)
                answer_dict["qa_pred"]["pred"].append(output)
            ...
            output_results.append(answer_dict)

    result_dir = os.path.join(config.output, "results.json")
